...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2022 at 08:49 AM
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_pelanggan`, `username`, `password`, `alamat`, `telp`, `foto_pelanggan`) VALUES
(5, 'Faiz Brigez', 'FaizAbadi', '29262197c139b1bfe3c7a4254735a32c', 'Sawojajar', '085678795005', 'Brigez_Abadi.jpg');
...
CREATE TABLE `petugas` (
  ...
  `level` enum('Admin','Manager','Petugas') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Raiandhra Cyostra', 'Rei', '6cfe4f746eeefa16626da5ab26757499', 'Admin'),
(2, 'Jerry the Fox', 'Jerry', 'aabd0fd1b8717c5200765b7e2fe6b878', 'Manager'),
(3, 'Jamal the Monkey', 'Jamal', '63418fbf9e9210dd205c83fbf3575398', 'Petugas');
...
(4, 'ROG Zephyrus G14 GA401', '8-core AMD Ryzen™ 9 5900HS CPU - GeForce RTX™ 3060 GPU', 20000000, 'Zephyrus_G14_GA401.png'),
(5, 'ROG Strix SCAR 15 G533', 'CPU AMD Ryzen™ 9 5900HX - GPU GeForce RTX™ 3080', 25000000, 'Strix_SCAR_15_G533.png'),
(6, 'ROG Zephyrus M16 GU603', 'CPU Intel® Core™ i9-11900H - GPU NVIDIA® GeForce RTX™ 3060', 30000000, 'Zephyrus_M16_GU603.png');
